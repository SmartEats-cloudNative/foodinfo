   ...
   stage('Check code coverage') {
            steps {
                script {
                    ...
                    def componentKey = "com.example:foodinfo"
      ...
      steps {
          ...
          sh 'docker build -t lavanyasimham/foodinfo-service:${VERSION} .'
          sh 'docker push lavanyasimham/foodinfo-service:${VERSION}'
      }
    } 
    ...
    stage('Update Image Tag in GitOps') {
      steps {
        ...
        script {
       sh '''
          sed -i "s/image:.*/image: lavanyasimham\\/foodinfo-service:${VERSION}/" aws/food-catalogue-manifest.yml
        '''
